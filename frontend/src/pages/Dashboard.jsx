...
import { getDashboardStats, planProject, getPlugins } from '../api/client';
  ...
  if (!stats) return (
    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '60vh' }}>
      <div style={{ textAlign: 'center', color: 'var(--text-muted)' }}>
        ...
        <p style={{ marginTop: 16 }}>Connecting...</p>
      </div>
    </div>
  );
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 12, lineHeight: 1.5 }}>
            Connect Claude Code, Cursor, or any MCP client to orchestrate missions directly from your IDE.
          </p>
          <div style={{
            ...
            <button
              onClick={() => {
                navigator.clipboard.writeText('claude mcp add mission-control --transport http http://localhost:18801/mcp');
                setMcpCopied(true);
          ...
          <div style={{ display: 'flex', gap: 6, marginTop: 10, flexWrap: 'wrap' }}>
            {['plan_project', 'create_mission', 'get_dashboard', 'list_missions', 'submit_report'].map(t => (
              <span key={t} style={{
